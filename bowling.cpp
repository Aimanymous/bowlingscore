...
void getFrames(Frame frames[]) {
    ...
    for (int i = 0; i < MAX_FRAMES; i++) {
        ...
        if (i < 9) {
            ...
            if (temp == 'x' || temp == 'X') {
                ...
                frames[i].firstBowl = (int)(temp - '0');
                pins = 10 - frames[i].firstBowl;
                ...
                else if ((int)(temp - '0') >= pins) {
                    frames[i].secondBowl = Spare;
                    frames[i].thirdBowl = 0;
                }
                else {
                    frames[i].secondBowl = (int)(temp - '0');
                    frames[i].thirdBowl = 0;
                }
            }
        }
    ...
    // Display Overall Frames
    cout << "Overall Frames:" << endl;
    for (int z = 1; z <= MAX_FRAMES; z++) {
        cout << "Frame " << z << "\t";
    }
    cout << endl;
